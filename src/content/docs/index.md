...
description: Parcours guidé pour configurer et utiliser Ma Compta Simplifié.
---

Bienvenue dans la documentation de **Ma Compta Simplifié**.
...
2. Configuration
   - [Configuration d’entité](./configuration/entite/)
   - [Plan comptable](./configuration/plan-comptable/)
   - [Ajout d’exercice](./configuration/exercice/)
